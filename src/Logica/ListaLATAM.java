    ...
    public void informacion(List<String> solicitudUser, JsonNode jsonCountries ) throws MalformedURLException{
            ...
            JsonNode countryNode2 = pais.get(quantity);
                ...
                JsonNode giniNode = pais.get(quantity).get("gini");
                        ...
                        String[] encabezados = { "Pais", "Capital", "Moneda", "Region", "SubRegion","Poblacion", "InicioSemana", "Gini"};
                        String[] datos = {nombre,capital,moneda,region,subRegion, String.valueOf(poblacion), inicioSemana,gini};
                        String archivoCSV = "datos.csv";
                        PaisesDAO paisesDao = new PaisesDAO();
                        paisesDao.createTableLatam();
                        paisesDao.createLATAM(nombre, capital, moneda, region, subRegion, String.valueOf(poblacion), inicioSemana, gini);}
            ...
            main.LATAM(mensajeBuilder.toString());
    }
}
